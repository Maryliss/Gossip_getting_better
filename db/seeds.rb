...
20.times do
	potin = Potin.create!(title: Faker::SiliconValley.app,content: Faker::SiliconValley.motto,user_id: rand(User.first.id..User.last.id))
end
...
# 	rand(Tag.first.id..Tag.last.id).times do #nb aléatoire de tags pour tout Potin
# 		join_table_gossip_tag = JoinTablePotinTag.create!(gossip_id: Potin.find(i+1).id,tag_id: rand(Tag.first.id..Tag.last.id))
# 	end
# end
...
20.times do
	comment = Comment.create!(content: Faker::SiliconValley.motto,user_id: rand(User.first.id..User.last.id),potin_id: rand(Potin.first.id..Potin.last.id))
end

# 20.times do |i| #on va aller chercher chacun des gossips
# 	comment = Comment.find_by(potin_id: i+1) #on lui trouve le commentaire associé, car tout les gossip
# 	rand(0..Comment.last.id).times do #nb aléatoire de tags pour tout Gossip
# 		comment = Comment.create!(content: Faker::SiliconValley.motto,user_id: rand(User.first.id..User.last.id),potin_id: rand(Potin.first.id..Potin.last.id))
# 		Comment.create!(content: Faker::SiliconValley.motto,user_id: rand(User.first.id..User.last.id),potin_id: rand(Potin.first.id..Potin.last.id))
# 	end
# end
...
# 		Comment.create!(content: Faker::SiliconValley.motto,user_id: rand(User.first.id..User.last.id),gossip_id: rand(Gossip.first.id..Gossip.last.id))
# 	end
# end
